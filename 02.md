...
# Allostaza wymaga przewidywania potrzeb
...
- **Predykcji** opartych na wiedzy (modelu generatywnym)
...
* Model generatywny to probabilistyczna reprezentacja tego, jak nieobserwowalne przyczyny w świecie prowadzą do obserwowalnych konsekwencji - naszych doświadczeń

---

# Modele generatywne

![](img/02_generative_models.png)
...
# PP to przede wszystkim teoria neurobiologiczna

- PP mówi o zasadach, wg. których skonstruowane są układy nerwowe!
...
# Active inference a poruszanie się (motor control)
